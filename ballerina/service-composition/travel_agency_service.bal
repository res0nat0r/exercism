...
service /travel on new http:Listener(9090) {
    ...
    resource function post arrangeTour(@http:Payload TourArrangement tour) returns error? {
    ...
    // Airline Reservation request shold be in this format : 
    // {"name":"", "arrivalDate":"", "departureDate":"", "preference":""}
